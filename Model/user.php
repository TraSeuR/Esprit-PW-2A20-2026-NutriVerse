...
class user
{
    ...
    public function __construct(string $nom, string $prenom, string $email, string $mot_de_passe, string $role, string $remember_me, string $etat_compte, string $avatar = 'avatar1.png')
    {
        $this->nom = $nom;
        $this->prenom = $prenom;
        $this->email = $email;
