...
if (btnRefresh) {
  btnRefresh.addEventListener('click', function () {
    ...
    var sortSelect = document.getElementById('u-sort-table');
    if (sortSelect) sortSelect.value = 'id_asc';
    filterTable();
    if (sortSelect) sortTable();
  });
}
...
// =========================
function sortTable() {
  var table = document.getElementById("users-tbody");
  var rows = Array.from(table.getElementsByTagName("tr"));
  var sortValue = document.getElementById("u-sort-table").value;
