    ...
    <main class="auth-form-side">
      <div class="auth-form-box">
        ...
        <?php if (isset($_GET['error']) && $_GET['error'] === 'invalid_credentials'): ?>
            <div style="background-color: #f8d7da; color: #721c24; border: 1px solid #f5c6cb; border-radius: 8px; padding: 12px; margin-bottom: 20px; text-align: center; font-weight: 500; font-size: 0.95rem;">
                ⚠️ Adresse e-mail ou mot de passe incorrect. Veuillez réessayer.
            </div>
        <?php endif; ?>
        <!-- Login form-->
