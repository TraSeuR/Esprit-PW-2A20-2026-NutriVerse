...
require_once __DIR__ . '/OffreC.php';
require_once __DIR__ . '/EchangeC.php';
...
class AdminC {
    ...
    public function handleRequest() {
        ...
        require_once __DIR__ . '/../view/backoffice/gestion offre/dashboard_admin.php';
    }
}

// Router
if (basename($_SERVER['PHP_SELF']) == 'AdminC.php') {
