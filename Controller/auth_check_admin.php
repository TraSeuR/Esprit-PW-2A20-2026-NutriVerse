...
// ── 3. Block access if not logged in or not a staff member ──
$staff_roles = ['admin', 'Administrateur', 'Responsable recette', 'Responsable Produit', 'Responsable commande', 'Livreur', 'Responsable Programmes', 'Responsable Offre & ingrediant'];
if (!isset($_SESSION['id_user']) || !in_array($_SESSION['role'], $staff_roles)) {
    /*
