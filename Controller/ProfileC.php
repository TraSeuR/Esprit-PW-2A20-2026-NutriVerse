...
class profileC
{
    ...
    public function processAddProfile()
    {
        ...
        $errors = [];
        if (empty($telephone))
            $errors[] = 'telephone_required';
        if (empty($date_naissance))
            $errors[] = 'date_required';
        if (empty($sexe))
            $errors[] = 'sexe_required';
        if ($poids <= 0)
            $errors[] = 'poids_required';
        if ($taille <= 0)
            $errors[] = 'taille_required';
        if (empty($objectif_nutritionnel))
            $errors[] = 'objectif_required';
        if (empty($preference_alimentaire))
            $errors[] = 'preference_required';
