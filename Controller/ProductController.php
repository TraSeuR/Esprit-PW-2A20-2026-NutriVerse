...
class ProductController
{
    ...
    public function __construct()
    {
        ...
        $this->productModel = new ProductModel(config::getConnexion());
    }
    ...
    public function listProducts()
    {
        ...
        require __DIR__ . '/../view/FrontOffice/produits.php';
    ...
    public function frontPage()
    {
        ...
        require __DIR__ . '/../view/FrontOffice/commande/header.php';
        require __DIR__ . '/../view/FrontOffice/front.php'; // votre contenu HTML
        require __DIR__ . '/../view/FrontOffice/commande/footer.php';
    }
}
