...
$list = $userC->listUser()->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="fr">
...
<body>
  ...
  <div class="main-content">
    ...
    <main class="dashboard-content u-section" id="section-utilisateurs" style="display:none;">
      ...
      <!-- ── SEARCH & FILTERS ─────────────────────────────────── 
      <section class="u-toolbar fade-up" style="margin-bottom:24px;">
      ...
      ════════════════════════════════════════════════════════════════ -->
      <?php foreach ($list as $p):
        $prof = $profileC->getProfileById($p['id_user']);
        if (!$prof) {
          $prof = ['telephone' => '', 'date_naissance' => '', 'sexe' => '', 'poids' => '', 'taille' => '', 'objectif_nutritionnel' => '', 'preference_alimentaire' => '', 'allergies' => ''];
        }
        ?>
        <!-- MODAL VOIR -->
