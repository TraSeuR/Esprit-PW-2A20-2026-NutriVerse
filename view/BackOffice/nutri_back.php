...
<body>
  ...
  <aside class="sidebar" id="sidebar">
    <div class="sidebar-top">
      <div class="brand">
        <img src="view/BackOffice/images/logo.png" alt="Logo NutriVerse" class="brand-logo" />
        <div>
          <h2>NutriVerse</h2>
          <p>Back Office</p>
        </div>
            ...
            <table>
              ...
              <tbody>
                ...
                foreach($plannings as $p) {
                  ...
                  ?>
                  <tr>
                    <td><span style="font-weight: 500;"><?php echo htmlspecialchars($p->getTitrePlanning()); ?></span></td>
                    <td>
