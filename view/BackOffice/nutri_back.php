...
<body>
  ...
  <div class="main-content">
    ...
    <main class="dashboard-content">
      ...
      <section class="main-stats-grid fade-up delay-1">
        ...
        <div class="glass-card">
          <div class="stat-header">
            <span class="stat-label">Revenu Global</span>
            <div class="stat-icon-wrap icon-green"><i data-feather="dollar-sign"></i></div>
          </div>
          <h2 class="stat-val"><?= number_format($totalRevenue, 2) ?> <small style="font-size: 1rem;">DT</small></h2>
          <p style="font-size: 0.75rem; color: var(--muted); margin-top: 8px;">Ventes directes shop</p>
        </div>
        <div class="glass-card">
          <div class="stat-header">
          ...
          <p style="font-size: 0.75rem; color: var(--p-purple); margin-top: 8px; font-weight: 600;">+3 aujourd'hui</p>
        </div>
        <div class="glass-card">
          <div class="stat-header">
        ...
        <div class="glass-card chart-box">
          <div style="display: flex; justify-content: space-between; align-items: center;">
            <div>
              ...
              <p class="chart-sub">Volume de commandes mensuel (2026)</p>
            </div>
            <select style="background: #f8f9fa; border: 1px solid #eee; padding: 6px 12px; border-radius: 8px; font-size: 0.8rem;">
      ...
      <section class="activity-grid fade-up delay-3">
        ...
        <div class="glass-card">
          <div style="display:flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
            ...
            <a href="/integ/view/BackOffice/commande/commandes.php" style="font-size: 0.8rem; color: var(--p-blue); font-weight: 600; text-decoration: none;">Voir tout</a>
          </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      // Main Orders Chart
      const ctxOrders = document.getElementById('mainOrdersChart').getContext('2d');
      ...
      new Chart(ctxOrders, {
        ...
        options: {
          ...
          scales: {
            y: { beginAtZero: true, grid: { color: '#f1f3f5' }, border: { display: false } },
