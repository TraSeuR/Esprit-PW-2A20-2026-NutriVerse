  ...
  <div class="main-content">
    ...
    <main class="dashboard-content">
      <section class="page-header">
        <div>
          <span class="section-badge" style="background: #eaf8ef; color: #27ae60;">Mode Edition</span>
        ...
        <form id="produitForm" action="updateProduit.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="pl-form-grid">
            ...
            <div class="pl-form-group">
              ...
              if($existingImage): 
              ?>
                <p style="font-size:12px; color: green; margin-top: 5px;">Une image existe déjà.</p>
              <?php endif; ?>
            ...
            <div class="pl-form-actions">
              <button type="submit" class="export-btn" style="background: #27ae60; padding: 14px 35px; border-radius: 12px; font-weight: 600;">Mettre à jour</button>
            </div>
          </div>
        </form>
      </section>
