          ...
          <div class="container">
            ...
            <div class="sss-grid-2 ss-grid-2">
              ...
              <article class="sss-card ss-card">
                ...
                <form method="post" action="OffreController.php?action=delete" class="sss-form-grid ss-form-grid" style="margin-top: 14px">
          ...
          <div class="container">
            ...
            <div class="sss-grid-2 ss-grid-2">
              ...
              <article class="sss-card ss-card">
                ...
                <form method="post" action="EchangeController.php?action=delete&source=front" class="sss-form-grid ss-form-grid" style="margin-top: 14px">
