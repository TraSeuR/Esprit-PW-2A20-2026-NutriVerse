    ...
    <div class="container hero-grid">
      ...
      <div class="hero-visual fade-up delay-1">
        <div class="hero-main-img">
          <img src="view/FrontOffice/images/hero-salad.jpg" alt="Salade saine">
        </div>

        <div class="hero-side">
          <div class="small-img">
            <img src="view/FrontOffice/images/oranges.jpg" alt="Oranges et gingembre">
          </div>
          <div class="quote-box">
    ...
    <div class="container">
      ...
      <div class="recipe-grid">
        <div class="recipe-card large fade-up">
          <img src="view/FrontOffice/images/recipe1.jpg" alt="Recette 1">
        ...
        <div class="recipe-card fade-up delay-1">
          <img src="view/FrontOffice/images/recipe2.jpg" alt="Recette 2">
          <div class="recipe-overlay">
            <h3>Smoothie kiwi</h3>
            <span>10 min</span>
          </div>
        ...
        <div class="recipe-card fade-up delay-2">
          <img src="view/FrontOffice/images/recipe3.jpg" alt="Recette 3">
          <div class="recipe-overlay">
            <h3>Toast avocat</h3>
            <span>12 min</span>
          </div>
        ...
        <div class="recipe-card fade-up delay-3">
          <img src="view/FrontOffice/images/recipe4.jpg" alt="Recette 4">
          <div class="recipe-overlay">
        ...
        <div class="recipe-card fade-up delay-1">
          <img src="view/FrontOffice/images/recipe5.jpg" alt="Recette 5">
          <div class="recipe-overlay">
            <h3>Chia bowl</h3>
            <span>8 min</span>
          </div>
    ...
    <div class="container programs-grid">
      <div class="program-list fade-up">
        ...
        <div class="program-card">
          <img src="view/FrontOffice/images/elite.jpg" alt="Programme 1">
        ...
        <div class="program-card">
          <img src="view/FrontOffice/images/fitness.jpg" alt="Programme 2">
          <div class="program-info">
            <div>
        ...
        <div class="program-card">
          <img src="view/FrontOffice/images/detox.jpg" alt="Programme 3">
          <div class="program-info">
            <div>
              <h3>Reset Détox</h3>
    ...
    <div class="container">
      ...
      <div class="suivi-box fade-up delay-1">
        ...
        <div class="suivi-card">
          ...
          <p>Définissez vos objectifs : énergie, poids, équilibre et performance.</p>
        </div>
        <div class="suivi-card">
          <h3>Progression</h3>
