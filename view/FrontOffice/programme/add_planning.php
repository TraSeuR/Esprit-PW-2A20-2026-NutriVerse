  ...
  >
    ...
    <span>🥬</span>
        ...
        <div class="header-content">
            ...
            <h2 style="font-size: 2rem; opacity: 0.9; font-weight: 700; margin: 10px 0; color: white;">Étape 2</h2>
        </div>
    </section>
       ...
       <div class="glass-card planning-card" style="margin-bottom: 30px; padding: 25px;">
        ...
        <div class="glass-card planning-card">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px;">
                ...
                <a href="add_regime.php?id_regime=<?php echo htmlspecialchars($id_regime); ?>" class="btn-premium" style="width: auto; padding: 8px 20px; font-size: 0.8rem; background: var(--primary); color: #fff; text-decoration: none; border-radius: 12px; font-weight: 600;">REVENIR À L'É�tape 1</a>
            </div>
