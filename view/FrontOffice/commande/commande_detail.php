<section class="container my-orders">
    <div class="page-header fade-up">
        <a href="shop.php?action=my_orders" class="back-link">← Retour à mes commandes</a>
                ...
                <li><strong>Adresse :</strong> 
                    <?php if ($isPending): ?>
                        <div style="margin-top: 10px; padding: 15px; background: #f8f9fa; border-radius: 12px;">
                            <form action="shop.php?action=front_update_address" method="POST" style="display:flex; flex-direction:column; gap:10px;">
