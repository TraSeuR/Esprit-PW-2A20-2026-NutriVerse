...
<head>
    ...
    <meta name="description" content="NutriVerse à éditez votre profil complet." />
    <title>éditer Profil à NutriVerse</title>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <select class="form-input" style="padding-left: 15px;" id="preference_alimentaire"
                                    ...
                                    <option value="Vétarien" <?php echo (($prof['preference_alimentaire'] ?? '') === 'Vétarien') ? 'selected' : ''; ?>>Vétarien</option>
                                    <option value="Vegan" <?php echo (($prof['preference_alimentaire'] ?? '') === 'Vegan') ? 'selected' : ''; ?>>Vegan</option>
                                    <option value="Pescéarien" <?php echo (($prof['preference_alimentaire'] ?? '') === 'Pescéarien') ? 'selected' : ''; ?>>Pescéarien</option>
