            ...
            <div class="auth-form-box">
                <div class="auth-form-header">
                    ...
                    <?php if (isset($_GET['pending'])): ?>
                        <p
                            style="color:#b45309; background:#fef3c7; padding:10px; border-radius:8px; margin-bottom:15px; font-weight:600; font-size:.9rem;">
                            ⚠️ Votre compte n'est pas encore vérifié. Veuillez entrer le code envoyé par e-mail pour
                            l'activer.
                        </p>
                    <?php endif; ?>
                ...
                <?php if ($error): ?>
                    <div
                        style="background:#fef2f2;color:#991b1b;border:1px solid #fecaca;border-radius:8px;padding:12px;margin-bottom:16px;text-align:center;">
                ...
                <?php if ($msg): ?>
                    <div
                        style="background:#dcfce7;color:#166534;border:1px solid #bbf7d0;border-radius:8px;padding:12px;margin-bottom:16px;text-align:center;">
