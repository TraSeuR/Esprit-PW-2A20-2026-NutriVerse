...
<head>
    ...
    <meta name="description" content="NutriVerse à Choisissez votre nouveau mot de passe." />
    <title>Nouveau mot de passe à NutriVerse</title>
        ...
        <main class="auth-form-side">
            <div class="auth-form-box">
                <div class="auth-form-header">
                    ...
                    <p>Choisissez un mot de passe fort pour votre compte
                ...
                <?php if (!empty($errors)): ?>
                    <div
                        style="background:#fef2f2;color:#991b1b;border:1px solid #fecaca;border-radius:8px;padding:12px;margin-bottom:16px;">
    ...
    <script>
        document.getElementById('form-new-password').addEventListener('submit', function (e) {
            ...
            if (pwd.length < 8 || !/[A-Z]/.test(pwd) || !/[0-9]/.test(pwd) || !/[\W_]/.test(pwd)) {
                e.preventDefault();
                alert('Le nouveau mot de passe est trop faible. Veuillez respecter les critées.');
            }
        });
    </script>
</body>
