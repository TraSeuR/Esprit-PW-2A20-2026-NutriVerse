      ...
      <div class="auth-form-box">
        ...
        <?php foreach ($errors as $code): ?>
          <?php if (isset($errorMap[$code])): ?>
            <div
              style="background-color:#f8d7da;color:#721c24;border:1px solid #f5c6cb;border-radius:8px;padding:12px;margin-bottom:20px;text-align:center;font-weight:500;font-size:.95rem;">
              <?= $errorMap[$code] ?>
            </div>
          <?php endif; ?>
        <?php endforeach; ?>
        ...
        <a href="google_auth.php" class="btn-google" id="btn-google-login">
          <img src="../assets/images/google.svg" alt="Google" width="20" height="20" />
