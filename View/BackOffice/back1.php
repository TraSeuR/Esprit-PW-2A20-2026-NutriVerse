...
<body>
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-menu">
      <a href="nutri_back.php" class="menu-item active" data-section="dashboard">
        <i data-feather="grid"></i>
        <span>Dashboard</span>
      </a>

      <a href="RECETTE/admin.php" class="menu-item" data-section="other">
      ...
      <a href="programme/admin_dashboard.php" class="menu-item" data-section="other">
  ...
  <div class="main-content">
    ...
    <main class="dashboard-content" id="section-dashboard">
      ...
      <section class="page-header fade-up">
        <div>
          ...
          <p>
            Vue dénsemble intelligente de votre plateforme santé, nutrition et commandes.
          </p>
        </div>
      ...
      <?php if ($flashSuccess): ?>
        <div
          style="background:#dcfce7;color:#166534;border:1px solid #bbf7d0;border-radius:10px;padding:14px 20px;margin-bottom:20px;font-weight:500;">
          ?
          <?= $flashSuccess === 'user_added' ? 'Utilisateur ajouté avec succés.' : 'Utilisateur mis à jour avec succés.' ?>
        </div>
      <?php endif; ?>
      <?php if (!empty($flashErrors)): ?>
        <div
          style="background:#fef2f2;color:#991b1b;border:1px solid #fecaca;border-radius:10px;padding:14px 20px;margin-bottom:20px;">
      ...
      <section class="stats-grid">
        ...
        <div class="stat-card stat-placeholder">
          ...
          <p class="stat-subtitle">Les statistiques apparaéront ici</p>
        </div>
      ...
      <section class="charts-section">
        ...
        <div class="chart-card placeholder-card">
          ...
          <div class="chart-placeholder">
            ...
            <h4>Le graphique apparaéra ici</h4>
            <p>
              Cette zone sera connecté plus tard aux données rélles
        ...
        <div class="chart-card placeholder-card">
          <div class="chart-header">
            <div>
              <h3>Réartition des Recettes</h3>
              <p>Catéories principales les plus populaires</p>
            </div>
          ...
          <div class="chart-placeholder">
            ...
            <h4>Le graphique apparaéra ici</h4>
            <p>
              Cette section affichera plus tard la réartition
              des catéories selon les recettes enregistrées.
            </p>
          </div>
        </div>
      ...
      <section class="bottom-section">
        ...
        <div class="table-card">
          <div class="card-header">
            <div>
              <h3>Commandes Réentes</h3>
              <p>Derniées commandes passés sur la plateforme</p>
            </div>
          ...
          <div class="empty-table-box">
            ...
            <h4>Les commandes apparaéront ici</h4>
            <p>
              Les derniées commandes clients seront affichés automatiquement
              une fois la base de données connecté.
            </p>
          </div>
        </div>
        ...
        <div class="users-card">
          <div class="card-header">
            <div>
              ...
              <p>Derniées inscriptions</p>
            </div>
          </div>

          <div class="empty-users-box">
            <div class="empty-table-icon"></div>
            <h4>Les utilisateurs apparaéront ici</h4>
            <p>
    ...
    <!-- ---------------------------------------------------------------
         ...
         Insé par extension du Back Office NutriVerse
    ---------------------------------------------------------------- -->
    <main class="dashboard-content u-section" id="section-utilisateurs" style="display:none;">
      ...
      <section class="page-header fade-up">
        <div>
          ...
          <h1>Utilisateurs</h1>
          <p>Géez les comptes utilisateurs de la plateforme NutriVerse.</p>
        </div>
      ...
      <section class="stats-grid fade-up delay-1">
        ...
        <div class="stat-card">
          <div class="stat-info">
            <p>Administrateurs</p>
            <h2>2</h2>
            <span class="positive">Accé complet</span>
          </div>
      ...
      <section class="table-card fade-up">
        ...
        <div class="u-toolbar" style="margin-bottom:24px;">
          ...
          <div class="u-filters">
            <select id="u-filter-role" class="u-select">
              <option value="">Tous les rées</option>
            ...
            <select id="u-sort-table" class="u-select" onchange="sortTable()">
              ...
              <option value="id_desc">↓ Trier par ID (Déroissant)</option>
              ...
              <?php foreach ($list as $p): ?>
                <tr data-role="<?= strtolower($p['role'] ?? '') ?>"
                  ...
                  <td>
                    ...
                    <?php else: ?>
                      <span class="status pending">Déactivé</span>
                    <?php endif; ?>
                  </td>
        ...
        <div class="u-empty-state" id="u-empty-state" style="display:none;">
          ...
          <p>Modifiez vos critées de recherche ou ajoutez un nouvel utilisateur.</p>
      ...
      <?php foreach ($list as $p):
          ...
          <div class="u-modal" onclick="event.stopPropagation()">
            ...
            <div class="u-modal-hero">
              ...
              <div>
                ...
                <?php else: ?>
                  <span class="status pending" style="margin-left:8px;">Déactivé</span>
                <?php endif; ?>
              </div>
            </div>
        ...
        <div class="u-modal-overlay" id="modal-edit-<?= $p['id_user'] ?>"
          ...
          <div class="u-modal u-modal-wide" onclick="event.stopPropagation()">
            ...
            <form action="utilisateur/update.php" method="POST" novalidate>
              <?php echo csrf_field(); ?>
              ...
              <div class="u-form-grid">
                ...
                <div class="u-form-group">
                  <label class="u-form-label">Rée</label>
                ...
                <div class="u-form-group">
                  ...
                  <select name="etat_compte" class="u-form-input">
                    ...
                    <option value="desactive" <?= (($p['etat_compte'] ?? '') == 'desactive') ? 'selected' : '' ?>>Déactivé
                    </option>
                  </select>
                </div>
              </div>
              ...
              <div class="u-form-grid">
                ...
                <div class="u-form-group">
                  ...
                  <select name="preference_alimentaire" class="u-form-input">
                    ...
                    <option value="Vétarien" <?= (($prof['preference_alimentaire'] ?? '') == 'Vétarien') ? 'selected' : '' ?>>Vétarien</option>
                    <option value="Vegan" <?= (($prof['preference_alimentaire'] ?? '') == 'Vegan') ? 'selected' : '' ?>>Vegan
                    </option>
                    <option value="Pescéarien" <?= (($prof['preference_alimentaire'] ?? '') == 'Pescéarien') ? 'selected' : '' ?>>Pescéarien</option>
      ...
      <div class="u-modal-overlay" id="modal-add" onclick="closeModal('modal-add')">
        <div class="u-modal u-modal-wide" onclick="event.stopPropagation()">
          ...
          <form action="utilisateur/ajoute.php" method="POST" novalidate>
            <?php echo csrf_field(); ?>
            <div class="u-form-section">Identité</div>
            <!-- Avatar Selection -->
            <div class="u-form-group" style="grid-column: 1 / -1; margin-bottom: 20px;">
            ...
            <div class="u-form-grid">
              ...
              <div class="u-form-group">
                ...
                <select name="preference_alimentaire" class="u-form-input">
                  ...
                  <option value="Vétarien">Vétarien</option>
                  <option value="Vegan">Vegan</option>
                  <option value="Pescéarien">Pescéarien</option>
