...
<body>
    ...
    <div class="main-content" style="display: flex; flex-direction: column;">
        <!-- TOPBAR BLANCHE (sans recherche) -->
        <header class="topbar" style="justify-content: flex-end;">
        <div class="user-menu admin-box-style">
            <button class="user-btn transparent-btn" id="userMenuBtn" style="border: none; cursor: pointer;">
                <div class="user-avatar-circle"><?= strtoupper(substr($_SESSION['prenom'] ?? 'A', 0, 1)) ?></div>
            ...
            <div class="user-dropdown" id="userDropdown" style="top: 100%; right: 0; z-index: 9999;">
            ...
            <div class="form-card">
                ...
                <form id="recetteForm" method="POST"
                    ...
                    <div class="form-group">
                        <label>Nom</label>
                        <input type="text" id="nom" name="nom" value="<?= $recette_edit['nom'] ?? '' ?>">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description"
                            name="description"><?= $recette_edit['description'] ?? '' ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select id="categorie" name="categorie">
                            ...
                            <option value="Healthy" <?= (isset($recette_edit['categorie']) && $recette_edit['categorie'] == 'Healthy') ? 'selected' : '' ?>>
                                Healthy
                            </option>

                            <option value="Vegan" <?= (isset($recette_edit['categorie']) && $recette_edit['categorie'] == 'Vegan') ? 'selected' : '' ?>>
                                Vegan
                            </option>

                            <option value="Cuisine Durable" <?= (isset($recette_edit['categorie']) && $recette_edit['categorie'] == 'Cuisine Durable') ? 'selected' : '' ?>>
                                Cuisine Durable
                            </option>
