...
if (
    ...
    if (isset($_FILES['image']) && $_FILES['image']['tmp_name'] != "") {//tmp name fichier tmp fl serveur
        $image = file_get_contents($_FILES['image']['tmp_name']); //file truc : transforme lpic l données binaires
    }
