...
// On indique source='back' pour que le contrôleur redirige vers le dashboard après enregistrement
...
<body style="background: #e9f9ed; min-height: 100vh;">
<div class="floating-emojis">
    ...
    <div class="container fade-up"
        ...
        <header style="margin-bottom: 40px; text-align: center;">
            ...
            <p style="color: rgba(255,255,255,0.7); font-family: 'Poppins'; font-weight: 500;">Gestion Administrative NutriVerse</p>
        </header>

        <div class="regime-premium-card" style="padding: 50px; background: rgba(255, 255, 255, 0.95);">
            <form id="regimeFormAdmin"
                ...
                <div style="margin-top: 40px; display: flex; gap: 20px; justify-content: flex-end;">
                    ...
                    <button type="submit" class="btn-premium"
                        style="width: auto; padding: 15px 50px; font-weight: 700; border-radius: 12px; background: #59b84d; color: white;">ENREGISTRER LE RÉGIME</button>
                </div>
    ...
    <script>
        // Le front_validation écoute "regimeForm", ici on a mis id="regimeFormAdmin" pour la clarté
        // On le renomme dynamiquement pour que le script externe fonctionne
